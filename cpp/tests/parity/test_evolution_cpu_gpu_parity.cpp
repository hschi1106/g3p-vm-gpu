...
std::vector<g3pvm::evo::FitnessCase> simple_cases() {
  ...
  return {
      FitnessCase{{{"x", Value::from_int(-2)}}, Value::from_int(-1)},
      FitnessCase{{{"x", Value::from_int(-1)}}, Value::from_int(0)},
      FitnessCase{{{"x", Value::from_int(0)}}, Value::from_int(1)},
      FitnessCase{{{"x", Value::from_int(1)}}, Value::from_int(2)},
      FitnessCase{{{"x", Value::from_int(2)}}, Value::from_int(3)},
      FitnessCase{{{"x", Value::from_int(3)}}, Value::from_int(4)},
  };
}
