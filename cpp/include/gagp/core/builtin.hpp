...
#define GAGP_BUILTIN_HD __host__ __device__
#else
#define GAGP_BUILTIN_HD
#endif
...
GAGP_BUILTIN_HD inline const char* builtin_name(BuiltinId id) {
  switch (id) {
    case BuiltinId::Abs:
      return "abs";
    case BuiltinId::Min:
...
GAGP_BUILTIN_HD inline bool builtin_id_from_int(int value, BuiltinId& out) {
