...
### Retired Python evolution mapping

Stage 09 removes the complete Python evolution package, its 22 dedicated test
methods, and the one random-program method formerly embedded in `test_eval.py`.
