    ...
    def test_tool_runs_and_writes_detailed_logs(self):
        with tempfile.TemporaryDirectory(prefix="g3p_run_cpp_evo_") as td:
            ...
            fake_cli.write_text(
                ...
                "  shift\n"
                "done\n"
                "echo 'GEN 000 best=1.000000 mean=0.250000 program_key=prog_key_a'\n"
                "echo 'GEN 001 best=2.000000 mean=0.750000 program_key=prog_key_b'\n"
                "echo 'FINAL best=2.000000 program_key=prog_key_b selection=tournament crossover=typed_subtree'\n"
